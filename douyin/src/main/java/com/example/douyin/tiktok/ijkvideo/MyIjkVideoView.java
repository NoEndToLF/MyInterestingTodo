package com.example.douyin.tiktok.ijkvideo;
...
import com.example.douyin.tiktok.widget.MyResizeSurfaceView;
import com.example.douyin.tiktok.widget.MyResizeTextureView;

public class MyIjkVideoView extends BaseIjkVideoView {
    protected MyResizeSurfaceView mSurfaceView;
    protected MyResizeTextureView mTextureView;
    ...
    public static final int SCREEN_SCALE_CENTER_CROP_TIKTOK = 6;
    ...
    private void addSurfaceView() {
        ...
        mSurfaceView = new MyResizeSurfaceView(getContext());
    ...
    private void addTextureView() {
        ...
        mTextureView = new MyResizeTextureView(getContext());
